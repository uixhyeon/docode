  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        ...
        <p class="page-description">JWT, OAuth 등 API 인증 방식을 배웁니다.</p>
      </header>
...
const topics = [
  ...
  },
  {
    id: 'oauth',
    title: 'OAuth 2.0',
    description: 'OAuth 2.0 흐름'
  },
  {
    id: 'session-vs-token',
    title: 'Session vs Token',
    description: '세션과 토큰 비교'
  },
  {
    id: 'refresh-tokens',
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_api_auth')
  if (savedArticles) {
