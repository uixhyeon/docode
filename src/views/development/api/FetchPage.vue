  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>🌐 Fetch API</h1>
        <p class="page-description">Fetch API를 활용한 HTTP 요청을 배웁니다.</p>
      </header>
...
const tabs = [
  { name: 'Fetch', path: '/development/api/fetch', icon: '🌐' },
  { name: 'Query', path: '/development/api/query', icon: '📊' },
  { name: 'GraphQL', path: '/development/api/graphql', icon: '🔗' },
  { name: 'Auth', path: '/development/api/auth', icon: '🔐' },
]
...
const topics = [
  {
    id: 'get-request',
    title: 'GET 요청',
    description: 'Fetch GET 메서드'
  },
  {
    id: 'post-request',
    title: 'POST 요청',
    description: 'Fetch POST 메서드'
  },
  {
    id: 'headers',
    title: 'Headers',
  ...
  },
  {
    id: 'timeouts',
    title: 'Timeouts',
    description: 'AbortController로 취소'
  },
  {
    id: 'interceptors',
    title: 'Interceptors',
    description: '요청/응답 인터셉터'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_api_fetch')
  if (savedArticles) {
