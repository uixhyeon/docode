  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>🔗 GraphQL</h1>
        <p class="page-description">GraphQL을 활용한 API 구축과 활용을 배웁니다.</p>
      </header>
...
const topics = [
  ...
  },
  {
    id: 'mutations',
    title: 'Mutations',
    description: 'GraphQL 뮤테이션'
  },
  {
    id: 'subscriptions',
    title: 'Subscriptions',
    description: 'GraphQL 구독'
  },
  {
    id: 'apollo-client',
    title: 'Apollo Client',
    description: 'Apollo Client 라이브러리'
  },
  {
    id: 'schema-design',
    title: 'Schema Design',
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_api_graphql')
  if (savedArticles) {
