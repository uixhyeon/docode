  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        ...
        <p class="page-description">번들 크기 최적화를 배웁니다.</p>
      </header>
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_optimization_bundle')
  if (savedArticles) {
