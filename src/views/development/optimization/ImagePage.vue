  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        ...
        <p class="page-description">이미지 최적화 기법을 배웁니다.</p>
      </header>
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_optimization_image')
  if (savedArticles) {
