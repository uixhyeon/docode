  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        ...
        <p class="page-description">웹 성능 지표와 최적화를 배웁니다.</p>
      </header>
...
const topics = [
  ...
  },
  {
    ...
    description: 'Performance 측정'
  },
  {
    id: 'lighthouse',
    title: 'Lighthouse',
    description: 'Lighthouse 도구'
  },
  {
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_optimization_performance')
  if (savedArticles) {
