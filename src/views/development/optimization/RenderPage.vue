  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        ...
        <p class="page-description">렌더링 성능 최적화를 배웁니다.</p>
      </header>
...
const tabs = [
  { name: 'Render', path: '/development/optimization/render', icon: '🎨' },
  { name: 'Bundle', path: '/development/optimization/bundle', icon: '📦' },
  { name: 'Image', path: '/development/optimization/image', icon: '🖼️' },
  { name: 'Performance', path: '/development/optimization/performance', icon: '⚡' },
]
...
const topics = [
  {
    id: 'memoization',
    title: 'Memoization',
    description: 'React.memo & useMemo'
  },
  {
    id: 'useCallback',
    title: 'useCallback',
    description: '콜백 함수 최적화'
  },
  {
    id: 'render-tracking',
    title: '리렌더링 추적',
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_optimization_render')
  if (savedArticles) {
