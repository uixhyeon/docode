  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>📦 Context API</h1>
        <p class="page-description">React Context API를 활용한 상태 관리를 배웁니다.</p>
      </header>
...
const tabs = [
  ...
  { name: 'Zustand', path: '/development/state/zustand', icon: '🎯' },
...
const topics = [
  {
    id: 'createContext',
    title: 'createContext',
    description: 'Context 생성'
  },
  {
    id: 'useContext-hook',
    title: 'useContext Hook',
    description: 'Context 사용'
  },
  {
    id: 'provider',
    title: 'Provider',
  ...
  },
  {
    id: 'custom-hooks',
    title: 'Custom Hooks',
    description: '커스텀 훅 활용'
  },
  {
    id: 'multi-level-context',
    title: 'Multi-level Context',
    description: '중첩 Context 관리'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_state_context')
  if (savedArticles) {
