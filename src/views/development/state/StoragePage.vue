  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>💾 Local/Session Storage</h1>
        <p class="page-description">브라우저 스토리지를 활용한 상태 관리를 배웁니다.</p>
      </header>
...
const topics = [
  ...
  },
  {
    ...
    description: 'sessionStorage 사용'
  },
  {
    id: 'indexedDB',
    title: 'IndexedDB',
    description: 'IndexedDB 활용'
  },
  {
    id: 'storage-events',
    title: 'Storage Events',
    description: '스토리지 이벤트 감지'
  },
  {
    id: 'storage-sync',
    title: 'Storage 동기화',
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_state_storage')
  if (savedArticles) {
