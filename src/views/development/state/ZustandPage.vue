  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>🎯 Zustand</h1>
        <p class="page-description">경량 상태 관리 라이브러리 Zustand를 배웁니다.</p>
      </header>
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_state_zustand')
  if (savedArticles) {
