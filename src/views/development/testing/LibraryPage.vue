  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        ...
        <p class="page-description">React Testing Library를 활용한 컴포넌트 테스트를 배웁니다.</p>
      </header>
...
const topics = [
  ...
  },
  {
    ...
    description: '테스트 작성 베스트 프랙티스'
  },
  {
    id: 'react-hooks-testing',
    title: 'React Hooks Testing',
    description: 'Hooks 테스트'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_testing_library')
  if (savedArticles) {
