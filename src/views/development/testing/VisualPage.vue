  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>👁️ Visual Testing</h1>
        <p class="page-description">시각적 회귀 테스트를 배웁니다.</p>
      </header>
...
const topics = [
  {
    id: 'storybook',
    title: 'Storybook',
    description: 'Storybook 컴포넌트 라이브러리'
  },
  {
    id: 'chromatic',
    title: 'Chromatic',
    description: 'Chromatic 비주얼 테스트'
  },
  {
    id: 'percy',
    title: 'Percy',
    description: 'Percy 시각적 회귀 테스트'
  },
  {
    id: 'screenshot-testing',
    title: 'Screenshot Testing',
    description: '스크린샷 테스트'
  },
  {
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_testing_visual')
  if (savedArticles) {
