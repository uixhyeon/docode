  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>📰 기술 블로그</h1>
        <p class="page-description">추천 기술 블로그와 아티클을 소개합니다.</p>
      </header>
...
const topics = [
  ...
  },
  {
    id: 'medium',
    title: 'Medium',
    description: 'Medium 기술 아티클'
  },
  {
    id: 'personal-blog',
    title: '개인 블로그',
    description: '유명 개발자 블로그'
  },
  {
    id: 'css-tricks',
    title: 'CSS-Tricks',
    description: 'CSS-Tricks 웹 디자인'
  },
  {
  ...
  },
  {
    id: 'tech-news',
    title: '기술 뉴스',
    description: 'Hacker News, Echo JS'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_references_blog')
  if (savedArticles) {
