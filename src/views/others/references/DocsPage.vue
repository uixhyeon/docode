  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>📘 공식 문서</h1>
        <p class="page-description">각 기술의 공식 문서를 활용하는 방법을 배웁니다.</p>
      </header>
...
const topics = [
  ...
  },
  {
    id: 'vue-docs',
    title: 'Vue Docs',
    description: 'Vue 공식 문서'
  },
  {
    id: 'mdn-web-docs',
    title: 'MDN Web Docs',
    description: 'MDN 웹 문서'
  },
  {
    id: 'typescript-handbook',
    title: 'TypeScript Handbook',
    description: 'TypeScript 핸드북'
  },
  {
    id: 'javascript-info',
    title: 'JavaScript.info',
    description: 'JavaScript 튜토리얼'
  },
  {
    id: 'docs-reading-tips',
    title: '문서 읽기 팁',
    description: '효율적인 문서 읽기'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_references_docs')
  if (savedArticles) {
