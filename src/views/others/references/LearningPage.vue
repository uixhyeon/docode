  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>📚 학습 자료</h1>
        <p class="page-description">추천 학습 자료와 강좌를 소개합니다.</p>
      </header>
...
const topics = [
  {
    id: 'udemy',
    title: 'Udemy',
    description: 'Udemy 온라인 강좌'
  },
  {
    id: 'coursera',
    title: 'Coursera',
    description: 'Coursera 대학 강좌'
  },
  {
    id: 'codecademy',
    title: 'Codecademy',
    description: 'Codecademy 대화형 학습'
  },
  {
    id: 'freecodecamp',
    title: 'FreeCodeCamp',
    description: 'FreeCodeCamp 무료 강좌'
  },
  {
    id: 'book-recommendations',
    title: '책 추천',
    description: '추천 기술 서적'
  },
  {
    id: 'online-community',
    title: '온라인 커뮤니티',
    description: 'Dev.to, Hashnode 등'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_references_learning')
  if (savedArticles) {
