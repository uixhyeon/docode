  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>🎥 영상 강좌</h1>
        <p class="page-description">YouTube 및 영상 플랫폼 추천 강좌를 소개합니다.</p>
      </header>
...
const tabs = [
  { name: 'Docs', path: '/others/references/docs', icon: '📘' },
  { name: 'Learning', path: '/others/references/learning', icon: '📚' },
  { name: 'Blog', path: '/others/references/blog', icon: '📰' },
  { name: 'Video', path: '/others/references/video', icon: '🎥' },
]
...
const topics = [
  {
    ...
    description: '유튜브 기술 채널'
  },
  {
    id: 'traversy-media',
    title: 'Traversy Media',
    description: 'Traversy Media 웹 개발'
  },
  {
    id: 'the-net-ninja',
    title: 'The Net Ninja',
    description: 'The Net Ninja 웹 개발'
  },
  {
    id: 'academind',
    title: 'Academind',
    description: 'Academind 프로그래밍'
  },
  {
    id: 'conference-talks',
    title: 'Conference Talks',
    description: '기술 컨퍼런스 발표'
  },
  {
    id: 'korean-channels',
    title: '한국 채널',
    description: '한국 기술 유튜브'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_references_video')
  if (savedArticles) {
