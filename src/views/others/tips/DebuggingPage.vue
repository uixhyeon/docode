  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>🐛 디버깅 팁</h1>
        <p class="page-description">효율적인 디버깅 기법과 팁을 배웁니다.</p>
      </header>
...
const tabs = [
  { name: 'VS Code', path: '/others/tips/vscode', icon: '⚙️' },
  { name: 'Productivity', path: '/others/tips/productivity', icon: '⚡' },
  { name: 'Debugging', path: '/others/tips/debugging', icon: '🐛' },
  { name: 'Code Review', path: '/others/tips/review', icon: '👀' },
]
...
const topics = [
  {
    id: 'console-methods',
    title: 'Console 메서드',
    description: 'console.log, assert 등'
  },
  {
    id: 'debugger-statement',
    title: 'Debugger 문',
    description: 'debugger 키워드'
  },
  {
    id: 'breakpoints',
    title: '중단점 팁',
    description: '효율적인 중단점 사용'
  },
  {
    id: 'source-maps',
    title: 'Source Maps',
  ...
  },
  {
    ...
    title: '네트워크 디버깅',
    description: '네트워크 이슈 해결'
  },
  {
    id: 'memory-leaks',
    title: '메모리 누수',
    description: '메모리 누수 찾기'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_tips_debugging')
  if (savedArticles) {
