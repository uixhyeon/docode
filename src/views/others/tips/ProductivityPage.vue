  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>⚡ 생산성 팁</h1>
        <p class="page-description">개발 생산성 향상을 위한 팁을 공유합니다.</p>
      </header>
...
const topics = [
  {
    id: 'time-management',
    title: '시간 관리',
    description: 'Pomodoro 기법'
  },
  {
    id: 'ide-optimization',
    title: 'IDE 최적화',
    description: '개발 환경 최적화'
  },
  {
    id: 'automation',
    title: 'Automation',
  ...
  },
  {
    id: 'monitor-setup',
    title: '모니터 설정',
    description: '다중 모니터 활용'
  },
  {
    id: 'note-taking',
    title: '참고 자료 관리',
    description: 'Note-taking 도구'
  },
  {
    id: 'collaboration',
    title: '동료 협업',
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_tips_productivity')
  if (savedArticles) {
