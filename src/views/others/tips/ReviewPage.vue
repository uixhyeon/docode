  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>👀 코드 리뷰</h1>
        <p class="page-description">효과적인 코드 리뷰 문화를 만듭니다.</p>
      </header>
...
const topics = [
  ...
  },
  {
    id: 'feedback-writing',
    title: '피드백 작성',
    description: '건설적인 피드백'
  },
  {
    id: 'pr-writing',
    title: 'PR 작성',
    description: 'Pull Request 작성법'
  },
  {
    id: 'github-features',
    title: 'GitHub Features',
    description: 'GitHub 리뷰 기능'
  },
  {
    id: 'automation',
    title: '자동화',
    description: 'CI/CD와 Lint'
  },
  {
    id: 'team-culture',
    title: '팀 문화',
    description: '리뷰 문화 구축'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_tips_review')
  if (savedArticles) {
