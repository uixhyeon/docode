  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>⚙️ VS Code 팁</h1>
        <p class="page-description">VS Code 설정과 확장 프로그램을 소개합니다.</p>
      </header>
...
const topics = [
  ...
  },
  {
    id: 'themes-fonts',
    title: '테마 & 폰트',
    description: '테마와 폰트 설정'
  },
  {
    id: 'shortcuts',
    title: '키보드 단축키',
    description: '효율적인 단축키'
  },
  {
    id: 'snippets',
    title: 'Snippets',
  ...
  },
  {
    ...
    description: 'VS Code 설정'
  },
  {
    id: 'multi-cursor',
    title: 'Multi-cursor',
    description: '다중 선택 및 편집'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_tips_vscode')
  if (savedArticles) {
