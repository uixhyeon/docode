  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>🏗️ Build Tools</h1>
        <p class="page-description">Webpack, Vite 등 빌드 도구를 다룹니다.</p>
      </header>
...
const topics = [
  {
    id: 'webpack',
    title: 'Webpack',
    description: 'Webpack 모듈 번들러'
  },
  {
    id: 'vite',
    title: 'Vite',
    description: 'Vite 빌드 도구'
  },
  {
    id: 'rollup',
    title: 'Rollup',
    description: 'Rollup 번들러'
  },
  {
    id: 'parcel',
    title: 'Parcel',
    description: 'Parcel 빠른 번들러'
  },
  {
    id: 'configuration',
    title: 'Configuration',
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_tools_build')
  if (savedArticles) {
