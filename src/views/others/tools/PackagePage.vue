  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        ...
        <p class="page-description">npm, yarn, pnpm 등 패키지 매니저를 다룹니다.</p>
      </header>
...
const topics = [
  ...
  },
  {
    id: 'yarn',
    title: 'yarn',
    description: 'Yarn 패키지 매니저'
  },
  {
    id: 'pnpm',
    title: 'pnpm',
    description: 'pnpm 고속 패키지 매니저'
  },
  {
    id: 'package-json',
    title: 'package.json',
    description: 'package.json 설정'
  },
  {
    id: 'dependencies',
    title: 'Dependencies',
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_tools_package')
  if (savedArticles) {
