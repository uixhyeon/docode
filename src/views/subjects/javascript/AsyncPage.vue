  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>⏳ 비동기 처리</h1>
        <p class="page-description">콜백, Promise, async/await 등 비동기 처리를 다룹니다.</p>
      </header>
...
const tabs = [
  { name: 'ES6+', path: '/subjects/javascript/es6', icon: '🆕' },
  { name: 'Async', path: '/subjects/javascript/async', icon: '⏳' },
  { name: 'Patterns', path: '/subjects/javascript/patterns', icon: '🔨' },
  { name: 'Utils', path: '/subjects/javascript/utils', icon: '🛠️' },
]
...
const topics = [
  {
    id: 'callbacks',
    title: 'Callbacks',
    description: '콜백 함수와 콜백 지옥'
  },
  {
    id: 'promises',
    title: 'Promises',
    description: 'Promise 체인과 상태 관리'
  },
  {
    id: 'async-await',
    title: 'async/await',
    description: '동기식 비동기 코드 작성'
  },
  {
    id: 'promise-all-race',
    title: 'Promise.all/race',
    description: '다중 Promise 처리'
  },
  {
    id: 'error-handling',
    title: 'Error Handling',
    description: 'try-catch와 에러 처리'
  },
  {
    id: 'generators',
    title: 'Generators',
    description: 'Generator 함수와 yield'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_javascript_async')
  if (savedArticles) {
