  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>🆕 ES6+ 문법</h1>
        <p class="page-description">ES6 이상의 최신 JavaScript 문법을 학습합니다.</p>
      </header>
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_javascript_es6')
  if (savedArticles) {
