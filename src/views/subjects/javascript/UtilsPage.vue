  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>🛠️ Utility & 라이브러리</h1>
        <p class="page-description">JavaScript 유틸리티 함수와 유용한 라이브러리를 다룹니다.</p>
      </header>
...
const topics = [
  ...
  },
  {
    id: 'array-methods',
    title: '배열 메서드',
    description: 'map, filter, reduce 등'
  },
  {
    id: 'string-handling',
    title: '문자열 처리',
    description: 'String 메서드와 정규식'
  },
  {
    id: 'date-handling',
    title: '날짜 처리',
    description: 'Date와 Luxon 라이브러리'
  },
  {
    id: 'deep-clone',
    title: 'Deep Clone',
    description: '깊은 복사 구현'
  },
  {
    id: 'currying-partial',
    title: 'Currying & Partial',
    description: '함수형 유틸리티'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_javascript_utils')
  if (savedArticles) {
