  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>🎣 React Hooks</h1>
        <p class="page-description">React Hooks의 핵심 개념과 활용법을 다룹니다.</p>
      </header>
...
const topics = [
  {
    id: 'useState',
    title: 'useState',
    description: '상태 관리의 기본, useState Hook 활용법'
  },
  {
    id: 'useEffect',
    title: 'useEffect',
    description: '사이드 이펙트 처리와 생명주기 관리'
  },
  {
    id: 'useContext',
    title: 'useContext',
    description: 'Context API를 활용한 전역 상태 관리'
  },
  {
    id: 'useRef',
    title: 'useRef',
    description: 'DOM 접근과 값 유지하기'
  },
  {
    id: 'useMemo-useCallback',
    title: 'useMemo & useCallback',
    description: '성능 최적화를 위한 메모이제이션'
  },
  {
    id: 'custom-hooks',
    title: 'Custom Hooks',
    description: '재사용 가능한 로직 추상화'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_react_hooks')
  if (savedArticles) {
