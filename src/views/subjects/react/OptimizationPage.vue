  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>⚡ React 최적화</h1>
        <p class="page-description">React 애플리케이션 성능 최적화 기법들입니다.</p>
      </header>
...
const topics = [
  {
    id: 'react-memo',
    title: 'React.memo',
    description: '컴포넌트 리렌더링 최적화'
  },
  {
    id: 'useMemo',
    title: 'useMemo',
    description: '값 메모이제이션으로 연산 최적화'
  },
  {
    id: 'useCallback',
    title: 'useCallback',
  ...
  },
  {
    ...
    description: 'React.lazy와 Suspense를 활용한 코드 분할'
  },
  {
    id: 'virtual-dom',
    title: 'Virtual DOM 이해',
    description: 'React의 렌더링 메커니즘'
  },
  {
    id: 'performance-profiling',
    title: 'Performance Profiling',
    description: 'React DevTools로 성능 측정하기'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_react_optimization')
  if (savedArticles) {
