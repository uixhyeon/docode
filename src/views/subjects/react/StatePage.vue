  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>📦 React 상태 관리</h1>
        <p class="page-description">다양한 상태 관리 패턴과 라이브러리 활용법입니다.</p>
      </header>
...
const topics = [
  {
    ...
    description: 'Props를 통한 상태 전달과 문제점'
  },
  {
    id: 'context-api',
    title: 'Context API',
    description: '전역 상태 관리를 위한 React Context'
  },
  {
    id: 'redux-toolkit',
    title: 'Redux Toolkit',
    description: 'Redux의 현대적인 사용법'
  },
  {
    id: 'zustand',
    title: 'Zustand',
  ...
  },
  {
    id: 'recoil',
    title: 'Recoil',
    description: 'React를 위한 상태 관리 라이브러리'
  },
  {
    id: 'jotai',
    title: 'Jotai',
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_react_state')
  if (savedArticles) {
