  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>⚙️ tsconfig 설정</h1>
        <p class="page-description">TypeScript 설정 파일(tsconfig.json)을 이해하고 최적화합니다.</p>
      </header>
...
const topics = [
  {
    ...
    description: '컴파일러 옵션 설정'
  },
  {
    id: 'target-module',
    title: 'Target & Module',
    description: '타겟 버전 및 모듈 시스템'
  },
  {
    id: 'strict-mode',
    title: 'Strict Mode',
    description: '엄격한 타입 체킹'
  },
  {
    id: 'path-mapping',
    title: 'Path Mapping',
    description: '경로 별칭 설정'
  },
  {
    id: 'sourcemap',
    title: 'sourceMap',
  ...
  },
  {
    ...
    title: '프로젝트 참조',
    description: 'project references 설정'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_typescript_config')
  if (savedArticles) {
