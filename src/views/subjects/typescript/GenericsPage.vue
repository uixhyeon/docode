  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>📦 Generics (제네릭)</h1>
        <p class="page-description">제네릭을 활용한 재사용 가능한 컴포넌트 개발을 배웁니다.</p>
      </header>
...
const topics = [
  ...
  },
  {
    ...
    description: '제약 조건 추가'
  },
  {
    id: 'keyof',
    title: 'Keyof',
    description: '객체 키 타입 추출'
  },
  {
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_typescript_generics')
  if (savedArticles) {
