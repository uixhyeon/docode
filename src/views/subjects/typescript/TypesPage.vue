  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>📘 TypeScript 타입 시스템</h1>
        <p class="page-description">TypeScript의 타입 시스템과 기본 개념을 학습합니다.</p>
      </header>
...
const topics = [
  {
    id: 'basic-types',
    title: '기본 타입',
    description: 'string, number, boolean 등'
  },
  {
    id: 'union-intersection',
    title: 'Union & Intersection',
    description: '합집합과 교집합 타입'
  },
  {
    id: 'type-aliases',
    title: 'Type Aliases',
    description: '타입 별칭 정의'
  },
  {
    id: 'interfaces',
    title: 'Interfaces',
    description: '인터페이스와 구조적 타이핑'
  },
  {
    id: 'enums',
    title: 'Enums',
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_typescript_types')
  if (savedArticles) {
