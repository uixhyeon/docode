  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        ...
        <p class="page-description">Vue 3의 Composition API를 활용한 컴포넌트 개발 방법을 다룹니다.</p>
      </header>
...
const topics = [
  {
    id: 'ref-reactive',
    title: 'ref와 reactive',
    description: '반응형 상태 관리의 기초'
  },
  {
    id: 'computed',
    title: 'computed',
    description: '계산된 속성과 의존성 추적'
  },
  {
    id: 'watch',
    title: 'watch와 watchEffect',
    description: '상태 변화 감시 및 부수 효과 처리'
  },
  {
    id: 'lifecycle',
    title: 'Lifecycle Hooks',
    description: '컴포넌트 생명주기 관리'
  },
  {
    id: 'provide-inject',
    title: 'provide/inject',
    description: '깊은 컴포넌트 통신'
  },
  {
    id: 'teleport',
    title: 'teleport',
    description: '컴포넌트를 다른 DOM 위치로 렌더링'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_vue_composition')
  if (savedArticles) {
