  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>⚡ Vue 최적화</h1>
        <p class="page-description">Vue 애플리케이션의 성능 최적화 전략을 배웁니다.</p>
      </header>
...
const topics = ref([
  {
    id: 'lazy-loading',
    title: 'Lazy Loading',
    description: '컴포넌트 코드 분할 및 지연 로딩'
  },
  {
    id: 'keep-alive',
    title: 'Keep-alive',
    description: '컴포넌트 상태 유지'
  },
  {
    id: 'virtual-scrolling',
    title: 'Virtual Scrolling',
    description: '대량 리스트 렌더링 최적화'
  },
  {
    id: 'suspense',
    title: 'Suspense',
    description: '비동기 컴포넌트 처리'
  },
  {
    id: 'ssr-ssg',
    title: 'SSR & SSG',
