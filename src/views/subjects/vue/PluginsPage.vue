  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>🔌 Vue Plugins</h1>
        <p class="page-description">Vue 플러그인 개발과 활용에 대해 학습합니다.</p>
      </header>
...
const topics = [
  {
    id: 'plugin-structure',
    title: 'Plugin 구조',
    description: 'Vue 플러그인의 기본 구조와 작성법'
  },
  {
    id: 'app-use',
    title: 'app.use()',
    description: '플러그인 등록 및 사용'
  },
  {
    id: 'global-properties',
    title: 'Global Properties',
    description: '전역 속성 등록'
  },
  {
    id: 'global-components',
    title: 'Global Components',
    description: '전역 컴포넌트 등록'
  },
  {
    id: 'directives',
    title: 'Directives',
    description: 'Vue 디렉티브 개발'
  },
  {
    id: 'popular-plugins',
    title: '유명한 플러그인',
    description: 'Vue Router, Pinia 등 주요 생태계'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_vue_plugins')
  if (savedArticles) {
