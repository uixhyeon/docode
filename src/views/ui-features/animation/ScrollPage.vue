  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        ...
        <p class="page-description">스크롤 기반 애니메이션을 구현합니다.</p>
      </header>
...
const topics = [
  {
    ...
    description: '요소 가시성 감지'
  },
  {
    id: 'scroll-events',
    title: 'Scroll Events',
    description: 'scroll 이벤트 처리'
  },
  {
    id: 'parallax-effect',
  ...
  },
  {
    ...
    description: '스크롤 페이드인'
  },
  {
    id: 'animate-on-scroll',
    title: 'Animate on Scroll',
    description: 'AOS 라이브러리'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_animation_scroll')
  if (savedArticles) {
