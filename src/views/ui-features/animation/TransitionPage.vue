  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        ...
        <p class="page-description">CSS 트랜지션으로 부드러운 애니메이션을 만듭니다.</p>
      </header>
...
const topics = [
  {
    ...
    description: 'transition 속성 사용'
  },
  {
    id: 'timing-functions',
    title: 'Timing Functions',
    description: 'easing 함수'
  },
  {
    id: 'delay',
    title: 'Delay',
    description: '애니메이션 지연'
  },
  {
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_animation_transition')
  if (savedArticles) {
