  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        ...
        <p class="page-description">토스트, 스낵바 등 알림 컴포넌트를 구현합니다.</p>
      </header>
...
const tabs = [
  { name: 'Button', path: '/ui-features/component/button', icon: '🔘' },
  { name: 'Form', path: '/ui-features/component/form', icon: '📝' },
  { name: 'Card', path: '/ui-features/component/card', icon: '🃏' },
  { name: 'Notification', path: '/ui-features/component/notification', icon: '🔔' },
]
...
const topics = [
  ...
  },
  {
    id: 'dismissible',
    title: 'Dismissible',
    description: '닫기 가능한 알림'
  },
  {
    id: 'toast-libraries',
    title: 'Toast Libraries',
    description: 'react-hot-toast 등'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_component_notification')
  if (savedArticles) {
