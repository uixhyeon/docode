  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        ...
        <p class="page-description">제스처 인식 및 터치 상호작용을 구현합니다.</p>
      </header>
...
const topics = [
  {
    id: 'touch-events',
    title: 'Touch Events',
    description: 'touchstart, touchmove, touchend'
  },
  {
    id: 'pointer-events',
    title: 'Pointer Events',
    description: '통합 포인터 이벤트'
  },
  {
    id: 'swipe-detection',
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_interaction_gesture')
  if (savedArticles) {
