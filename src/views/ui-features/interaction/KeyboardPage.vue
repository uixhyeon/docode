  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>⌨️ 키보드 인터랙션</h1>
        <p class="page-description">키보드 이벤트와 접근성을 고려한 상호작용을 다룹니다.</p>
      </header>
...
const topics = [
  ...
  },
  {
    ...
    description: 'Tab 키 네비게이션'
  },
  {
    id: 'accessibility',
    title: 'Accessibility (a11y)',
    description: 'WCAG 접근성 표준'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_interaction_keyboard')
  if (savedArticles) {
