  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>🃏 Card Layout</h1>
        <p class="page-description">카드 기반 레이아웃 구현 방법을 배웁니다.</p>
      </header>
...
const topics = [
  ...
  },
  {
    id: 'hover-effects',
    title: 'Hover Effects',
    description: '호버 효과와 상호작용'
  },
  {
    id: 'masonry-layout',
    title: 'Masonry Layout',
    description: '핀터레스트 스타일 레이아웃'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_layout_card')
  if (savedArticles) {
