  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>📊 Grid Layout</h1>
        <p class="page-description">CSS Grid를 활용한 레이아웃을 배웁니다.</p>
      </header>
...
const topics = [
  ...
  },
  {
    id: 'responsive-grid',
    title: '반응형 Grid',
    description: 'auto-fit, minmax 활용'
  },
  {
    id: 'alignment',
    title: 'Alignment',
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_layout_grid')
  if (savedArticles) {
