  ...
  <div class="subcategory-page">
    ...
    <div class="page-content">
      <header class="page-header">
        <h1>🪟 Modal & Dialog</h1>
        <p class="page-description">모달 및 다이얼로그 레이아웃을 구현합니다.</p>
      </header>
...
const tabs = [
  ...
  { name: 'Dashboard', path: '/ui-features/layout/dashboard', icon: '🖼️' },
  { name: 'Card', path: '/ui-features/layout/card', icon: '🃏' },
...
const topics = [
  {
    ...
    description: '모달 구조 및 백드롭'
  },
  {
    id: 'dialog-element',
    title: 'Dialog Element',
    description: 'HTML dialog 요소'
  },
  {
    id: 'overlay-backdrop',
  ...
  },
  {
    id: 'accessibility',
    title: 'Accessibility',
    description: 'ARIA와 focus 관리'
  },
  {
    id: 'animation',
    title: 'Animation',
    description: '모달 오픈/클로즈 애니메이션'
  },
  {
    id: 'stack-management',
    title: '스택 관리',
    description: '다중 모달 관리'
  }
]
...
onMounted(() => {
  const savedArticles = localStorage.getItem('articles_layout_modal')
  if (savedArticles) {
